...
<h3 align="center">ByeLoggers</h3>

<p align="center">A Simple, Fast and Efficient IP Logger Spammer</p>
...
## Previews
[Video](https://youtu.be/QCTI0Poo86E)

## FAQ
- **Q: How to use ByeLoggers?**
- A: You must first download the requirements with the command `pip install -r requirements.txt` and then follow the instructions after starting ByeLoggers with the command `python main.py`. You can also run the downloadable executable directly from the [Releases](https://github.com/TurfuFrogy/ByeLoggers/releases).
